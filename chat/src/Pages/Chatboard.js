                  ...
                  
                  {
                    !plusview &&(
                      <FiPlus onClick={fileAni} id="plus"/>
                         ...
                         <LuSticker onClick={fileSticker} id="emoji"  /><input type="text" placeholder="Type a message..."  onKeyDown={handleKeyDown} id="entered-msg" value={chat} onChange={handleChange} onClick={secondDiv}  inputMode="none" />
